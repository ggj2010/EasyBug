        ...
        <div class="content-1">
            <div class="title">
                <div class="title-span left">
                    <span> <fmt:message key="biUserInfo.table_title"></fmt:message><fmt:message key="btn.add" /></span>
                </div>
                <div class="right">
            ...
            <div class="main-page-230 margin-lr-1 over-flow-x-hidden">
                <form id="form1" action="${path}/main/biUserInfo/addOne/save.do" enctype="multipart/form-data" method="post">
                <table class="add-tb">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="col-6">
                            <div class="input-group input-group-lg">
                            <span class="input-group-addon"><input type="checkbox" name="isReceiveEmail" value="Y"></span>
