                ...
                <div class="margin-lr-1">
                    <div class="main-page-270 over-flow-x-hidden">
                        <form id="form1" action="${path}/main/biRole/update/save.do" method="post">
                        	<input type="hidden" value="${biRole.id}" name='id'>
                            <table class="add-tb">
                                <tr>
                                    <td class="td-title">
                                ...
                                <tr>
                                    <td class="col-12">
                                        <div class="input-group input-group-lg">
											...
											<input class="form-control" type="text" id="keyTxt" required="required" name="name" value="${biRole.name}">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="col-12">
                                        <div class="input-group input-group-lg">
                                            ...
                                            <textArea class="form-control" rows="2" cols="2" name="discription">${biRole.discription}
                                            </textArea>
                                        </div>
                                    </td>
                                </tr>
