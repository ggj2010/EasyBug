    ...
    <head>
        ...
        $(document).ready(function(){
			...
			function view(id){
				...
				params+="&userAssignerId="+assigner;
        ...
        <div id="main-div" class="width-p100">
            ...
            <div class="content main-page-190">
                ...
                <div class="margin-lr-1">
                	<form id="form1" action="${path}/main/count/bugContent/assigner.do" method="get">
                		...
                		<tr>
							<td class="ltd2" colspan="2">
								<div class="margin-lr-1">
									...
									<a class="btn btn-danger" href="javaScript:open('assigner');" >Bug分配者 </a>
				                        ...
				                        <table class="list-tb" width="100%">
				                            <thead>
				                                <tr>
													...
													<th id="numberTh"> 
													<span id="numberTitle">分配BUG总数</span>
													</a>
				                                    </th>
				                                    <th>
