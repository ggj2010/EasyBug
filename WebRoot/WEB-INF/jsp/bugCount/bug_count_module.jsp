        ...
        <div id="main-div" class="width-p100">
            ...
            <div class="content main-page-190">
                ...
                <div class="margin-lr-1">
                	<form id="form1" action="${path}/main/count/bugContent/version.do" method="get">
                		...
                		<tr>
							<td class="ltd2" colspan="2">
								<div class="margin-lr-1">
									...
									<a class="btn btn-danger" href="javaScript:open('module');" >模块</a>
				                    ...
				                    <c:if test='${fn:length(sumList)>0}'>
				                        <table class="list-tb" width="100%">
				                            <thead>
				                                <tr>
													<th> 
                                                    	<span id="biOrganNamseTitle">模块名称</span>
													</a>
													</th>
													<th id="numberTh"> 
													<span id="numberTitle">模块BUG数量</span>
													</a>
				                                    </th>
				                                    <th>
