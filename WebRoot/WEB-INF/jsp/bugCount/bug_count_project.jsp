        ...
        <div id="main-div" class="width-p100">
            ...
            <div class="content main-page-190">
                ...
                <div class="margin-lr-1">
                	<form id="form1" action="${path}/main/count/bugContent/project.do" method="get">
                	...
                	<table class="add-tb">
                		...
                		<tr>
							<td class="ltd2" colspan="2">
								<div class="margin-lr-1">
									<div class="left">
									<a class="btn btn-danger" href="javaScript:open('project');" >项目</a>
				                    ...
				                    <c:if test='${fn:length(sumList)>0}'>
				                        <table class="list-tb" width="100%">
				                            <thead>
				                                <tr>
													<th> 
                                                    	<span id="biOrganNamseTitle">项目</span>
													</a>
													</th>
													<th id="numberTh"> 
