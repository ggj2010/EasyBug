    ...
    <body>
        <div id="main-div" class="width-p100">
            ...
            <div class="content-1 main-page-190">
            	<div class="title">
            		<div class="title-span left"><span>分配给我Bug<fmt:message key="btn.search" /></span></div>
            	</div>
                <div class="margin-lr-1">
                <form id="form1" action="${path}/main/bugContent/belognToMe/list.do" method="get">
                            ...
                            <thead>
                                ...
                                <c:forEach var="item" items='${pageData.result}' varStatus="s">
                                    <tr>
                                        ...
                                        <td>
                                        <c:if test="${item.isClosed=='N'&&item.isOpen=='Y'&&item.isSolved=='N'}">
										  ...
										  <c:if test="${item.isClosed=='Y'&&item.isOpen=='N'}">
										   ...
										   <c:if test="${item.isClosed=='Y'&&item.isOpen=='Y'}">
											 ...
											 <c:if test="${item.isClosed=='N'&&item.isOpen=='Y'&&item.isSolved=='Y'}">
										   	审核中
										   	</c:if>
										</td>
								    </tr>
