    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function initParam(){
                ...
                $("#isClosed").val("${bugContent.isClosed}");
    ...
    <body>
        <div id="main-div" class="width-p100">
            ...
            <div class="content-1 main-page-190">
                ...
                <form id="form1" action="${path}/main/bugContent/review/list.do" method="get">
                            ...
                            <thead>
                                ...
                                <c:forEach var="item" items='${pageData.result}' varStatus="s">
                                	...
                                	<c:if test="${item.isClosed=='N'}">
                                        ...
                                        <td>
                                        <c:if test="${item.isClosed=='N'&&item.isSolved=='Y'}">
                                           <c:if test="${fn:contains(btnStr, 'b1')}" > <a class="btn btn-default btn-lg " role="button" href="${path}/main/bugContentProcess/process/view.do?id=${item.id}"><span class="glyphicon glyphicon-cog"></span>审核</a>&nbsp;&nbsp;&nbsp;
                                          </c:if>
										   </c:if>
										   <c:if test="${item.isClosed=='Y'}">
										   	已审核
										   	</c:if>
                                        </td>
								    </tr>
