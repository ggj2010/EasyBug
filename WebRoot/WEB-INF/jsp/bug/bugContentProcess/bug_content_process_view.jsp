                                                 ...
                                                 <div class="Gray box Detail clear">
                                                     <div class="Solution left">
                                                         <table border="0" width="100%"  class="bugdetail box">
                                                             ...
                                                             <c:forEach var="item" items='${bugContentVO.processList}' varStatus="s">
                                                                 <tr>
                                                                     <td width="12%">
                                                                         ...
                                                                         <c:if test="${(item.status=='solved'||item.status=='worksForMe'||item.status=='later')&&bugContent.isClosed=='N'}">
                                                             ...
                                                             <c:if test="${(bugContent.status=='solved'||bugContent.status=='worksForMe'||bugContent.status=='later')&&bugContent.isClosed=='N'}">
                                                                 <tr>
                                                                     <td width="12%">
											...
											<c:if test="${bugContent.isClosed=='N'&&bugContent.status!='new'}">
                                             <button type="submit" class="btn btn-default">
											  ...
											  <c:if test="${bugContent.isSolved=='Y'}">
                                                 <a class="btn btn-default" href="${path}/main/bugContent/close/save.do?id=${bugContent.id}"><span class="glyphicon glyphicon-off"></span>关闭</a>
                                             </c:if>
											 </c:if>
