...
<% 
	...
	request.setAttribute("projectUserList", request.getSession().getAttribute(Global.USER_ROLE_LIST)); 
...
<script type="text/javascript" src="${path}/ckeditor/ckeditor_config.js"></script> 
<script type="text/javascript" src="${path}/themes/js/swfobject.js"></script>
