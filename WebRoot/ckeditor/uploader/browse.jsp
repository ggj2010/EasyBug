...
<html>
    <head>
        ...
        <script type="text/javascript" src="../ckeditor_config.js">
        </script>
    ...
    <body>
        ...
        String clientPath = "ckeditor/uploader/upload/";
        ...
        out.println("  <img width='110px' height='70px' src='"+src+"' title='"+file.getName()+"' onclick=\"funCallback('"+callback+"','"+src+"')\" >             ");
        }
        }else{
