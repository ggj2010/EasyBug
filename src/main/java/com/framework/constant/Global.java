...
public class Global {
	...
	public static String USER_BUTTON_LIST = "USER_BUTTON_LISE";
	...
	/**
	 * 在xml配置文件中取得配置参数的值 实例： <name1><name2>value</name2></name1> 可通过getConfigValue(name1.name2)取得value
	 * @param configName 参数名称，用"."来标识结构
	 * @return 指定参数的值
	 */
